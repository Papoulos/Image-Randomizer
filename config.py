...
# --- Liste des modèles FLUX disponibles ---
# Pour ajouter un nouveau modèle FLUX, copiez la structure du dictionnaire
# ci-dessous et ajoutez-le à la liste FLUX_MODELS.
FLUX_MODELS = [
    {
        "name": "flux_workflow",
...
# --- Liste des modèles SDXL disponibles ---
# Pour ajouter un nouveau modèle SDXL, copiez la structure du dictionnaire
# ci-dessous et ajoutez-le à la liste SDXL_MODELS.
SDXL_MODELS = [
    {
        "name": "sdxl_workflow",
